...
-  폴더 구조 작성하기\
   ...
   -  **↘ api**
      ...
      -  tmdbApi.js : api 데이터 호출
         > $\textsf{\color{forestgreen}{export}}$ const $\textsf{\color{darkgray}{[getMovies], [getMovieDetails], [getMovieCredits] ...}}$ **→** ${\textsf{\color{hotpink}{moviesSlice.js}}}$\
         >  ㄴ $\textsf{\color{green}{import}}$ ｛ getMovies, getMovieDetails, getMovieCredits ｝$\textsf{\color{green}{from}}$ '../../api/tmdbApi'
         >
         > $\textsf{\color{forestgreen}{export}}$ const $\textsf{\color{darkgray}[{getTVs ...]}}$ **→** **${\textsf{\color{hotpink}{tvsSlice.js}}}$**\
